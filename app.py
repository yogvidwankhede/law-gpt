...
LEGAL_SYSTEM_PROMPT = (
    ...
    "  • Torts: Theory and Practice (4th ed.)\n"
    "  • Copyright Law: Cases and Materials (v7.0)\n"
    "  • Professional Responsibility (2nd ed.)\n"
    "  • Fundamentals of Property Law\n"
    "  • Introduction to the US Legal System\n"
    "  • Legal Reasoning and Legal Writing (9th ed.)\n"
    "  • Patent Law (Masur & Ouellette, 2025)\n"
    "  • Trademark Law\n"
    "  • The Bluebook: Uniform System of Citation\n"
    "  • Transnational Business Problems (7th ed.)\n"
    "  • Contracts: A Real World Casebook (2nd ed.)\n"
    "  • Corporations and Other Business Associations\n"
    "  • Ethical Problems in the Practice of Law (4th ed.)\n"
    "  • US Constitution\n"
